...
CONFIG_FROM_ENV_VARS = {
    ...
    'ckan.redirect_to': 'CKAN_REDIRECT_TO',
    'ckan.billing_host': 'CKAN_BILLING_HOST',
    'ckan.billing_port': 'CKAN_BILLING_PORT',
    'ckan.billing_project_name': 'CKAN_BILLING_PROJECT_NAME',
...
def update_config():
    ...
    env.filters['other_extend'] = jinja_extensions.other_extend
